...
def group[S: Signature[Multiset[Any]]](
    ...
    *keys: str,
    ...
    :param keys: fields with respect to which to group; use dotted notation to access
        nested fields; use a star ('*') to access all fields at a given depth
    ...
    fields = [field for field, _ in get_subalgebras(joined, *keys)]
